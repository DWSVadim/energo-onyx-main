    ...
    },
    {
      ...
      content: (
        <>
          ...
          <br></br>
          Если говорит что нету рядом СНИЛСа(страхового номера), но есть ПАССПОРТ 
          <br></br>
          Отвечаете: Давайте тогда по номеру ПАССПОРТА, но указываете только номер,без лишних данных таких как: кем выдан паспорт, код подразделения, место выдачи, мне в договоре необходимо указать только номер паспорта. Слушаю: ....
        </>
      )
    },
    {
