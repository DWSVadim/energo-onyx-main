            ...
            >
              ...
              <h5 style={{ textAlign: 'left', fontSize: '18px', lineHeight: '1.6', color: '#333' }}>
                ...
                <p>Также подскажите какое количество людей проживает вместе с вами
                  (Если спрашивают зачем)
                  Ответ: Что бы мы понимали какое количество людей потребляет электроэнэргию, если больше 2х людей, то на первые 3 месяца предусмотрена льгота.</p>
