...
function Apps() {
  ...
  const leftModalContent = [
    {
      id: "modal0",
      title: "ПОЧЕМУ ЗВОНИТЕ ПО ВОТСАП,СКАЙП,ДРУГОЙ РЕГИОН?",
      content: (
        <>
          Ответ 1:
          <br></br>
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://dws-energy.onrender.com/submit-form", {
      ...
      .then(() => {
        ...
        return fetch("https://script.google.com/macros/s/AKfycbxA6OJfFJkI7uCuQ0F2dw376J779CibmMaqN1CmEONC88t6jWwYdr-48zdNjoul3De5NA/exec", {
          method: "POST",
          ...
          <div className="col-4">
            ...
            >
              ...
              <h5 style={{ textAlign: 'left', fontSize: '18px', lineHeight: '1.6', color: '#333' }}>
                ...
                <p>- Мастер вам предварительно позвонит перед установкой, вы ему скажете номер счётчика, чтобы он сверил и установил именно ваш счётчик.</p>
                ...
                <p>Договор я составляю на ФИО КЛИЕНТА дата рождения (сверяем), и подскажите ваш страховой номер, так как вам за счет государства передается счетчик на бесплатной основе, его необходимо зарегистрировать по одному из двух регистрационных номеров снилса или паспорта,по какому вам будет удобнее?   </p>
