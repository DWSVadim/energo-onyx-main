          ...
          <div className="col-4">
            ...
            >
              ...
              <h5 style={{ textAlign: 'left', fontSize: '18px', lineHeight: '1.6', color: '#333' }}>
                ...
                <p>ФИО, Добрый день/вечер! С вами связывается энергасбыт. Меня зовут (Аносова Светлана Андреевна) (Аносов Виталий Андреевич)</p>
                ...
                <p>-Также, когда мастер приедет менять вам счётчик, вам необходимо будет подписать новый договор на обслуживание с энергасбытом. Договор будет в двух экземплярах. Один остаётся у вас, один у мастера. Он его передаст инспектору в энергасбыт. САМОЕ ГЛАВНОЕ - перед тем как допускать мастера к установке, вы проверяете его удостоверение, сверяете с номером счетчика который я вам назвала, и только потом допускаете его к работе, хорошо -ФИО КЛИЕНТА? </p>

                <p>Договор я составляю на ФИО дата рождения (сверяем), и подскажите ваш страховой номер, так как вам за счет государства передается счетчик на бесплатной основе, его необходимо зарегистрировать, по этому укажите ваш страховой номер ЧТО ЭТО ТАКОЕ? -ответ- : Это зеленая карта которая выдается отдельно от паспорта, - страховое свидетельство, просмотрите и укажите.</p>

                <p>-Давайте сверим данные по договору, вы (ФИО), дата рождения...</p>

                <p>Также для подключения льготы на оплату электроэнергии подскажите, сколько по вашему адресу проживает людей. В зависимости от количества проживающих людей в вашей квартире будет зависеть размер скидки на оплату электроэнергии (ответ)</p>
