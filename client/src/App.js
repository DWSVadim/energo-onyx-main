    ...
    },
    {
      ...
      content: (
        <>
          ...
          <br></br>
          ЕСЛИ ПРОСИТЕ ПАССПОРТ
          <br></br>
          А я у вас и не запрашиваю личных данных например: кем выдан паспорт, код подразделения, место выдачи, ваше место прописки, мне в договоре необходимо указать только регистрационный номер или паспорта или СНИЛСА, значения не имеет. По этому подскажите, какой из номеров мне указать? 
        </>
      )
    },
    {
