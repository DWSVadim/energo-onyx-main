          ...
          <div className="col-4">
            ...
            >
              ...
              <h5 style={{ textAlign: 'left', fontSize: '18px', lineHeight: '1.6', color: '#333' }}>
                ...
                <p>Договор я составляю на ФИО КЛИЕНТА дата рождения (сверяем), и подскажите ваш страховой номер. (Так как вам за счет государства передается счетчик на бесплатной основе, его необходимо зарегистрировать за вами по одному из двух регистрационных номеров либо снилс либо паспорт, подскажите по какому вам будет удобнее пройти регистрацию?   </p>
