          ...
          <div className="col-4">
            ...
            >
              ...
              <h5 style={{ textAlign: 'left', fontSize: '18px', lineHeight: '1.6', color: '#333' }}>
                ...
                <p>Если вам известно с начала 2025года новое постановление министерства энергетики номер 77 согласно которому необходимо до конца февраля всем жильцам заменить старые счётчики на новые оттчественные которые автоматически передают показания в энергосбыт. </p>
                ...
                <p>Договор я составляю на ФИО КЛИЕНТА дата рождения (сверяем), и подскажите ваш страховой номер.</p>
