          ...
          <div className="col-4">
            ...
            >
              ...
              <h5 style={{ textAlign: 'left', fontSize: '18px', lineHeight: '1.6', color: '#333' }}>
                ...
                <p>(Фио)-Клиента(Лариса Николаевна) также предусмотрена дополнительная льгота на случай плановой замены счетчика вы мне уточните сколько жильцов прописано по вашему адресу и сколько по факту проживает тут дело больше в самом расходе електро енергии на последуйщие 3 месяца после замены у вас будет автоматическое снижение тарифа </p>
                <p>Также нужно понимать есть ли жильцы которые не достигли совершенно летия</p>
